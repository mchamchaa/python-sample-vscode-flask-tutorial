[![Build Status](https://dev.azure.com/mchamchaa/automation/_apis/build/status/mchamchaa.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/mchamchaa/automation/_build/latest?definitionId=1&branchName=master)
